...
$uncleanmsg = file_get_contents('php://input');
		...
		if(strpos($uncleanmsg,'"published"') !== false){
			...
			if(isset($parsevar['entry'][0]['messaging'][0]['message']['mid'])){
				...
				$pagename = array_search($x_page_id,$arraypage,true);
				
				if ($x_page_id == $x_sender_id){
					
					$ins = "insert into fb_private_message set fbfrom_id='".$x_sender_id."', message='".str_replace("'", "", $x_text) ."', message_id='". $x_mid ."', created_time=from_unixtime('".$x_time."'/1000, '%Y-%m-%d %H:%i:%s'), fbto_id='". $x_recipient_id ."', object_id='". $x_seq ."', fb_page_id='". $x_page_id ."', fb_page_name='". $pagename ."', stat='MY COMMENT', sticker_id='".$x_sticker_id."'";
					#$ins = "insert into fb_private_message set fbfrom_id='".$x_sender_id."', message='".str_replace("'", "", $x_text) ."', message_id='". $x_mid ."', created_time='".$x_time."', fbto_id='". $x_recipient_id ."', object_id='". $x_seq ."', fb_page_id='". $x_page_id ."', fb_page_name='". $pagename ."', stat='MY COMMENT', sticker_id='".$x_sticker_id."'";
					
				}else{
					//REMOVE IF NEED IN BOT	
					$ins = "insert into fb_private_message set fbfrom_id='".$x_sender_id."', message='".str_replace("'", "", $x_text) ."', message_id='". $x_mid ."', created_time=from_unixtime('".$x_time."'/1000, '%Y-%m-%d %H:%i:%s'), fbto_id='". $x_recipient_id ."', object_id='". $x_seq ."', fb_page_id='". $x_page_id ."', fb_page_name='". $pagename ."', stat='PENDING', sticker_id='".$x_sticker_id."'";
					#$ins = "insert into fb_private_message set fbfrom_id='".$x_sender_id."', message='".str_replace("'", "", $x_text) ."', message_id='". $x_mid ."', created_time='".$x_time."', fbto_id='". $x_recipient_id ."', object_id='". $x_seq ."', fb_page_id='". $x_page_id ."', fb_page_name='". $pagename ."', stat='PENDING', sticker_id='".$x_sticker_id."'";
				/*  FOR BOT REPLY						
				...
				*/
					...
					if ($x_page_id == $x_sender_id){
					#if ($parsevar['entry'][0]['id'] == $parsevar['entry'][0]['messaging'][0]['sender']['id']){
						getProfile($x_page_id, "MESSAGING", $x_page_id);
						#getProfile($parsevar['entry'][0]['id'], "MESSAGING", $parsevar['entry'][0]['id']);
					}else{
						getProfile($x_sender_id, "MESSAGING", $x_page_id);
						#getProfile($parsevar['entry'][0]['messaging'][0]['sender']['id'], "MESSAGING", $parsevar['entry'][0]['id']);
					}
					
					#$dmax = $parsevar['entry'][0]['id']."-".$parsevar['entry'][0]['messaging'][0]['sender']['id'];
				...
				//wall comment handling
					...
					if($parsevar['entry'][0]['changes'][0]['value']['item'] == "comment"){
						...
						#x_comment_id
						#Objectid and postid 
						$commentidpiece = explode("_", $x_comment_id);
						$pagename = array_search($x_page_id,$arraypage,true);
							...
							if($x_page_id == $x_sender_id){
								...
								$ins = "insert into fb_mypost_comment set id='".$x_comment_id."', post_id='".$x_post_id."', aid='".$x_sender_name."', fromid='".$x_sender_id."', object_id='".$commentidpiece[0]."', post_fbid='".$commentidpiece[1]."', parent_id='".$x_parent_id."', time='".$x_created_time."', text='".$x_message."', fb_page_id='".$x_page_id."', status='MY COMMENT', fb_page_name='".$pagename."'";
				
							}else{
								
								//assumes subs reply
								
								$ins = "insert into fb_mypost_comment set id='".$x_comment_id."', post_id='".$x_post_id."', aid='".$x_sender_name."', fromid='".$x_sender_id."', object_id='".$commentidpiece[0]."', post_fbid='".$commentidpiece[1]."', parent_id='".$x_parent_id."', time='".$x_created_time."', text='".$x_message."', fb_page_id='".$x_page_id."', status='PENDING', fb_page_name='".$pagename."'";
...
$file = 'sql.txt';
$current = file_get_contents($file);
file_put_contents($file, $ins.PHP_EOL , FILE_APPEND | LOCK_EX);
